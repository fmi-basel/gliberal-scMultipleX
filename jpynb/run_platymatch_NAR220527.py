...
def runPM(moving_pc, fixed_pc, ransac_iterations, icp_iterations, moving_raw_image, fixed_raw_image, moving_label_image, fixed_label_image, save_image_name, save_images= False):
...
def runAffine(moving_pc, fixed_pc, ransac_iterations, icp_iterations, save_images=False):
...
def runFFD(moving_pc, fixed_pc, ransac_iterations, icp_iterations, moving_raw_image, fixed_raw_image, moving_label_image, fixed_label_image, save_image_name, transform_matrix_combined, confidence, save_images=False):
