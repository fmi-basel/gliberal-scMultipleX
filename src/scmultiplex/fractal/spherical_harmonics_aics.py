...
from scmultiplex.aics_shparam import shtools, shparam
...
def spherical_harmonics_aics(
    ...
    for row in r0_adata.obs_names:
        ...
        #TODO: set lmax as variable in Fractal task
        ((coeffs, grid_rec),
         (image_, mesh_polydata_organoid, grid, transform)) = shparam.get_shcoeffs(image=edges_canny,
                                                                                   lmax=2,
                                                                                   spacing=spacing)
        ...
        if save_labels:
            ...
            #TODO: move this binary check higher, to spherical harmonics
