...
from scmultiplex.utils.accumulate_utils import save_tidy_plate_well_org_mem
...
@task()
def save_tidy_plate_well_org_mem_task(exp):
    save_tidy_plate_well_org_mem(exp)


with Flow(
    "Tidy Membrane Features",
    ...
    save_org = save_tidy_plate_well_org_mem_task(exps)
