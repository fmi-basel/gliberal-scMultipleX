...
from scmultiplex.utils.accumulate_utils import save_tidy_plate_well_org_nuc
...
@task()
def save_tidy_plate_well_org_nuc_task(exp):
    save_tidy_plate_well_org_nuc(exp)


with Flow(
    "Tidy Nuclei Features",
    ...
    save_org = save_tidy_plate_well_org_nuc_task(exps)
